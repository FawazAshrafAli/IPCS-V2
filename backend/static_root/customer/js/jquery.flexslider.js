...
(function ($) {
  ...
  $.flexslider = function(el, options) {
    ...
    methods = {
      ...
      controlNav: {
        ...
        setupPaging: function() {
          ...
          if (slider.pagingCount > 1) {
            for (var i = 0; i < slider.pagingCount; i++) {
              ...
              item = (slider.vars.controlNav === "thumbnails") ? '<img src="' + slide.attr( 'data-thumb' ) + '"' + altText + '/>' : '<a target="_blank" href="https://deltasupplier.in/#">' + j + '</a>';
        ...
        update: function(action, pos) {
          if (slider.pagingCount > 1 && action === "add") {
            slider.controlNavScaffold.append($('<li><a target="_blank" href="https://deltasupplier.in/#">' + slider.count + '</a></li>'));
      ...
      pausePlay: {
        setup: function() {
          var pausePlayScaffold = $('<div class="' + namespace + 'pauseplay"><a target="_blank" href="https://deltasupplier.in/#"></a></div>');
