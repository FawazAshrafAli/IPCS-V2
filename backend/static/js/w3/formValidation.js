...
function warrantyValidate(){
    ...
    var newDiv = document.getElementById('warranty-assurance-section');
    
    newDiv.innerHTML = '<div class="text-center" id="loading-div"><div class="spinner-border" role="status"><span class="visually-hidden">Submitting...</span></div></div><br/>';
...
function repairValidate(){
    ...
    var newDiv = document.getElementById('repair-assurance-section');
...
function serviceValidate(){    
    ...
    var newDiv = document.getElementById('service-assurance-section');
...
function adminForgotPasswordValidate(){    
    var email=document.adminForgorPasswordForm.email.value;
    
    if(email==null|| email.trim().length === 0 || email[0] === ' '){        
        document.getElementById('forgot_username-span').innerHTML="<i>Required</i>";
        document.adminForgorPasswordForm.email.focus();
        document.adminForgorPasswordForm.email.style.border = "1px solid red";        
        scrollToError('forgot_username-span');
        return false;
    } else {        
        document.getElementById('forgot_username-span').innerHTML="";
        document.adminForgorPasswordForm.email.blur();
        document.adminForgorPasswordForm.email.style.border = "none";
    }
...
function readyToDispatchFileUpdateValidate(){
    var file=document.readyToDispatchFileUpdationForm.file.value;    

    if(file==null|| file.trim().length === 0 || file[0] === ' '){
        document.getElementById('file-span').innerHTML="<i>Required</i>";
        document.readyToDispatchFileUpdationForm.file.focus();
        document.readyToDispatchFileUpdationForm.file.style.border = "1px solid red";
        scrollToError('file-span');
        return false;
    } else {
        document.getElementById('file-span').innerHTML="";
        document.readyToDispatchFileUpdationForm.file.blur();
        document.readyToDispatchFileUpdationForm.file.style.border = "none";
    };

    var newDiv = document.getElementById('file-assurance-section');
...
function completedServiceFileUpdateValidate(){
    var file=document.completedServiceFileUpdationForm.file.value;    

    if(file==null|| file.trim().length === 0 || file[0] === ' '){
        document.getElementById('file-span').innerHTML="<i>Required</i>";
        document.completedServiceFileUpdationForm.file.focus();
        document.completedServiceFileUpdationForm.file.style.border = "1px solid red";
        scrollToError('file-span');
        return false;
    } else {
        document.getElementById('file-span').innerHTML="";
        document.completedServiceFileUpdationForm.file.blur();
        document.completedServiceFileUpdationForm.file.style.border = "none";
    };
